...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 3. Query INSERT ke tabel 'products'
    $stmt = $con->prepare("INSERT INTO products (nama, harga, deskripsi, kategori, status, gambar, crop_y) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sdssssi", $nama, $harga, $deskripsi, $kategori, $status, $fileName, $crop_y); 

    if ($stmt->execute()) {
        $message = '<div class="alert alert-success">✅ Produk berhasil ditambahkan! Kembali ke <a href="produk_dashboard.php" style="color: #fff; text-decoration: underline;">Dashboard Produk</a></div>';
    } else {
        $message = '<div class="alert alert-error">❌ Error: Gagal menambahkan produk. ' . $stmt->error . '</div>';
...
<head>
    ...
    <title>Tambah Produk Baru - Admin Rumah Que Que</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="form-container">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" id="harga" name="harga" placeholder="Contoh: 150000" required min="0" step="1000">
            ...
            <div class="form-group">
                ...
                <textarea id="deskripsi" name="deskripsi" placeholder="Tuliskan deskripsi lengkap tentang produk ini, termasuk spesifikasi, keunggulan, dan informasi penting lainnya..." required></textarea>
                <p class="helper-text">Jelaskan produk secara detail untuk membantu calon pembeli memahami produk Anda</p>
            </div>

            <!-- Form Actions -->
            <div class="form-actions">
                <button type="submit" class="btn-submit">✅ Simpan & Publikasikan Produk</button>
